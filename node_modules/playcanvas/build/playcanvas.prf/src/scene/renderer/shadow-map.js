import { FILTER_LINEAR, FILTER_NEAREST, pixelFormatInfo, TEXHINT_SHADOWMAP, ADDRESS_CLAMP_TO_EDGE, FUNC_LESS } from '../../platform/graphics/constants.js';
...
class ShadowMap {
	...
	static create2dMap(device, size, shadowType) {
		...
		const formatName = (_pixelFormatInfo$get = pixelFormatInfo.get(shadowInfo.format)) == null ? void 0 : _pixelFormatInfo$get.name;
	...
	static createCubemap(device, size, shadowType) {
		...
		const shadowInfo = shadowTypeInfo.get(shadowType);
		const formatName = (_pixelFormatInfo$get2 = pixelFormatInfo.get(shadowInfo.format)) == null ? void 0 : _pixelFormatInfo$get2.name;
