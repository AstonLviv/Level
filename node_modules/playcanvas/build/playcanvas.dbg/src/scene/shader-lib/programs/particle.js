...
import { BLEND_NORMAL, BLEND_ADDITIVE, BLEND_MULTIPLICATIVE, tonemapNames } from '../../constants.js';
...
class ShaderGeneratorParticle extends ShaderGenerator {
  ...
  createShaderDefinition(device, options) {
    ...
    const includes = new Map(Object.entries(_extends({}, shaderChunks, options.chunks)));
