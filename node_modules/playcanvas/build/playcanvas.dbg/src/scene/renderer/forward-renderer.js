...
class ForwardRenderer extends Renderer {
  ...
  renderForwardPrepareMaterials(camera, renderTarget, drawCalls, sortedLights, layer, pass) {
    ...
    const fogParams = (_camera$fog = camera.fog) != null ? _camera$fog : this.scene.fog;

    // camera shader params
    const shaderParams = camera.shaderParams;
    shaderParams.fog = fogParams.type;
    shaderParams.srgbRenderTarget = (_renderTarget$isColor = renderTarget == null ? void 0 : renderTarget.isColorBufferSrgb(0)) != null ? _renderTarget$isColor : false; // output gamma correction is determined by the render target
  ...
  renderForwardLayer(camera, renderTarget, layer, transparent, shaderPass, viewBindGroups, options = {}) {
    ...
    const fogParams = (_camera$fog2 = camera.fog) != null ? _camera$fog2 : this.scene.fog;
