...
class Preprocessor {
  ...
  static evaluate(expression, defines) {
    ...
    if (comparison) {
      ...
      const left = (_defines$get = defines.get(comparison[1])) != null ? _defines$get : comparison[1];
      const right = (_defines$get2 = defines.get(comparison[3])) != null ? _defines$get2 : comparison[3];
